...
int main() {
  ...
  */
  ...
  double tempo;
  inicio = clock();
  Matrix *A = matrix_create_rand(250000);
  matrix_print( A );
  Matrix *B = matrix_create_rand(250000);
  matrix_print( B );
  Matrix *C = matrix_add( A, B );
  matrix_print( C );
  matrix_destroy( C );
  ...
  */
  srand(time(NULL));
  clock_t inicio_bruta,fim_bruta;
  double tempo_bruta;
  float **mat1,**mat2,**mat3;
  inicio_bruta=clock();
  mat1=matrix_bruta(250000);
  print_bruta(mat1,250000);
  mat2=matrix_bruta(250000);
  print_bruta(mat2,250000);
  mat3=matrix_soma_bruta(mat1,mat2,250000);
  print_bruta(mat3,250000);
  matrix_destroy_bruta(mat3,250000);
  mat3=matrix_multiplica_bruta(mat1,mat2,250000);
  print_bruta(mat3,250000);
  matrix_destroy_bruta(mat3,250000);
  mat3=matrix_bruta_transposta(mat1,250000);
  print_bruta(mat3,250000);
  matrix_destroy_bruta(mat3,250000);  
  matrix_destroy_bruta(mat1,250000);  
  matrix_destroy_bruta(mat2,250000);  
  fim_bruta = clock();
